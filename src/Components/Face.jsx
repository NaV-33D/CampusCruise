...
const Face = () => {
  ...
  <label class="container-wrap">
    ...
    <p className='font-bold text-xl md:text-2xl text-white'>An App To Find Your </p>
...
<button
  ...
  className="cursor-pointer bg-[#010714] px-3 py-2 rounded-md text-white tracking-wider shadow-xl animate-bounce hover:animate-none top-[80%] md:top-[85%] right-10 md:right-[48%] absolute"
>
  <svg
    className="w-5 h-5"
    stroke="currentColor"
