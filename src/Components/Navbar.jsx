    ...
    return (
        <div className='absolute top-0 left-0 w-full h-20 z-10 bg-black'>
            ...
            items-centre py-4 px-6 md:px-10 lg:px-22'>
                ...
                <button className='hidden md:block bg-white px-9 py-2
                rounded-full'>SignUp</button>
                <img onClick={() => setshow(true)} src={ham} className='md:hidden w-7 cursor-pointer' />
            </div>

            <div className={`md:hidden ${show ? 'fixed w-full' : 'h-0 w-0'} overflow-hidden h-auto pb-10 bg-gray-800 text-white transition-all`}>
